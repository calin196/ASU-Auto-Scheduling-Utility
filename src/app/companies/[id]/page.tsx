...
export default function CompanyServicePage() {
  ...
  const selectedService = useMemo(() => {
    if (step1 === "repair" || step1 === "maintenance" || step1 === "diagnostic") {
  ...
  const selectedCategory = useMemo(() => {
    ...
    return (
      selectedService.categories.find((category) => category.key === step2) || null
    );
    ...
    <main className="auth-shell">
      <div className="auth-card" style={{ maxWidth: "980px" }}>
        ...
        >
          ...
          <strong>I don&apos;t know</strong> or use <strong>Other</strong> to write
          your own answer.
        </p>
        ...
        >
          ...
          >
            ...
            >
              {(Object.entries(SERVICE_TREE) as [Step1Key, ServiceTree[Step1Key]][]).map(
                ([key, value]) => (
                  <OptionCard
                    key={key}
                    label={value.label}
              ...
              <OptionCard
                ...
                locked={step1Finished}
                onSelect={() => setStep1(UNDETERMINED)}
              />
            </div>
          </div>
              ...
              >
                {(selectedService?.categories || []).map((category) => (
                  <OptionCard
                    ...
                    onSelect={() => setStep2(category.key)}
                  />
                ))}
                ...
                <OptionCard
                  ...
                  locked={step2Finished}
                  onSelect={() => setStep2(UNDETERMINED)}
                />
              </div>
            </div>
          )}
            ...
            >
              ...
              >
                ...
                <OptionCard
                  ...
                  locked={step3Finished}
                  onSelect={() => setStep3(UNDETERMINED)}
                />
              </div>
            </div>
          )}
