...
INSERT INTO "new_ServiceRequest" ("category", "clientId", "createdAt", "exactIssue", "id", "isNegotiable", "providerId", "quotedPrice", "serviceType", "status") SELECT "category", "clientId", "createdAt", "exactIssue", "id", "isNegotiable", "providerId", "quotedPrice", "serviceType", "status" FROM "ServiceRequest";
